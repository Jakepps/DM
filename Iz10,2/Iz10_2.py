...
#все слова алфавита A = { a, b, c, d, e, f, g, h, j, k} длины n, в которых одна буква
#повторяется не более k раз, одна буква повторяется ровно k+1 раз, одна буква
#повторяется или k+2 или k+3 раз, остальные буквы не повторяются.
