...
namespace Iz10_1
{
    class Program
    {
        ...
        public static StreamWriter file1 = new StreamWriter(@"Ответ1.txt");
        public static StreamWriter file2 = new StreamWriter(@"Ответ.txt");
        ...
        static void Main(string[] args)
        {
            ...
            file2.WriteLine("Все слова длины n, в которых 2 буквы повторяются k раз, остальные буквы не повторяются:");
            for (int j = 0; j < 6; j++)
            {
